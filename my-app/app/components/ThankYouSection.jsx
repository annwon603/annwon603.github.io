...
const ThankYou = () =>{
    return(
        <div className="mx-4 my-4 sm:mx-10 md:mx-40 md:my-10 xl:my-15 p-4">
            ...
            <p className={`${rubik.className} text-[#E1DDEB] font-light mt-1`}>
                Would love to chat, you can contact me at <a href="mailto:aniwong603@gmail.com" className="hover:text-[#ededed7e]">aniwong@gmail.com</a>
                <br></br>Or reach out via my socials below.</p>
            ...
            <div className="block w-auto space-x-8 mt-5">
                <div className="socials flex flex-row gap-3 xl:gap-1">
                    <Link href="https://github.com/annwon603">
                        <svg 
                            className="fill-[#E1DDEB] hover:fill-[#ededed7e]"
