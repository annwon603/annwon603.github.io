...
const ThankYou = () =>{
    return(
        <div className="mx-4 my-4 sm:mx-10 md:mx-40 md:my-10 xl:my-15 p-4">
            <h1 className={`${dogicaPixel.className}`}>Thanks for Stopping By!</h1>
            <p className={`${rubik.className} text-[#E1DDEB] font-light mt-1`}>Would love to chat, you can find me here...</p>
            {/* Contacts */}
            <div className="block w-auto space-x-8 mt-5">
                <div className="socials flex flex-row gap-3 xl:gap-1">
                    <Link href="https://github.com/annwon603">
                        <svg 
                            className="fill-[#E1DDEB]"
