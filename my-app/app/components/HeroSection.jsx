...
const HeroSection = () => {
    return (
        <div className="w-full max-w-4xl mx-auto p-4 mb-5 flex flex-col container justify-center items-center">
            ...
            <div className="flex md:hidden lg:hidden xl:hidden socials flex-row gap-4 mt-10">
                ...
                <Link href="https://github.com/annwon603">
                    ...
                    xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 30 30">
                ...
                <Link href="https://www.linkedin.com/in/annie-wong-4030a6226/">
                    <svg 
                    className="fill-[#A99DCF] hover:fill-[#2E2C39]"
                    xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 50 50">
